...
/*
    private URI createUrl() {
        URI url = UriComponentsBuilder.fromHttpUrl(trelloConfig.getTrelloApiEndpoint() + "/members/mariuszraton/boards")
...
*/
    ...
    public TrelloCreatedTrelloCard createNewCard(TrelloCardDto trelloCardDto) {
        ...
        return restTemplate.postForObject(url,null, TrelloCreatedTrelloCard.class);
